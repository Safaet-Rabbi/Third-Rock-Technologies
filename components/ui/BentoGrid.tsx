    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* Render Tech Stack Skill Boxes for id: 4 */}
          {id === 4 && (
            <div className="flex flex-wrap gap-3 mt-5">
              {skills.map((skill, index) => (
                <span
                  key={index}
                  className="px-4 py-2 bg-[#10132E] text-white text-sm rounded-lg shadow-md"
                >
                  {skill}
                </span>
              ))}
          ...
          {/* Email Copy Button and Animation for id: 6 */}
          {id === 6 && (
